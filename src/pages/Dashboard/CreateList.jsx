...
import Storage from "../../Firebase";
 ...
 import {CreateList} from '../../redux/actions/ListsAction';
...
import { MdOutlinePermIdentity,MdDateRange,MdPhoneIphone,MdMailOutline,MdLocationSearching,MdUpload } from 'react-icons/md';
 ...
 function CreateLists({GetALLMovie,allMovies,CreateList}) {
                      ...
                      <div className=''>
                          ...
                          <form >
                              ...
                              <div className='text-gray-900 flex items-center mt-5'>
                                    ...
                                    <button onClick={()=>CreateLists()} className='bg-blue-600  px-5 py-1 text-white rounded-lg'>Create</button>
...
export default connect(mapStateToProps,{GetALLMovie,CreateList})(CreateLists);